...
export const Hero = ({ title, description, pathImg }: TemplateTypes) => {
  return (
    <Background src={pathImg} className="flex items-center max-w-screen-xl mx-auto min-h-500" parentClassName="filter">
      ...
      <div className="absolute bg-primary top-20 -left-44 -rotate-30 w-28 h-60"></div>
