...
export const EditProject = ({ slugProject, businessId, slug }: { slugProject: string; businessId: number; slug: string }) => {
  ...
  const { response: resProject } = useGet<ResponseBusinessSectorTypes>({ path: `/projects/${slugProject}` });
      ...
      <AnimatePresence>
        {modal && (
          <Modal isVisible={modal} onClose={handleClose} className="max-w-2xl">
            <h3 className="text-lg font-semibold text-center sm:text-start text-primary">Edit Project</h3>
            <form onSubmit={handleSubmitForm} className="w-full mt-4 space-y-4">
              <div className="relative text-center">
                {errors && !project.header?.url ? (
                  <small className="w-full text-red-500">Enter image header please!</small>
                ) : (
              ...
              {errors && !project.title && <small className="w-full text-red-500">Enter title please!</small>}
              <div className="relative w-full">
                <input
                  type="text"
                  id="description"
              ...
              {errors && !project.description && <small className="w-full text-red-500">Enter description please!</small>}
              <div className="space-y-4">
                ...
                {errors && !project.media?.length && <small className="w-full text-red-500">Enter images please!</small>}
