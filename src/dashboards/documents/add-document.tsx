...
export const AddDocument = () => {
  ...
  const { response: categories, loading } = useGet<ResponseCategoriesDocumentTypes>({ path: "/documents/categories" });
            ...
            {loadData ? (
              ...
              <form onSubmit={handleSubmit} className="space-y-4 md:min-w-xl">
                ...
                <div className="space-y-4">
                  ...
                  {error && !category && <small className="text-red-500">Select document category!</small>}
                  ...
                  {error && !name && <small className="text-red-500">Enter document name!</small>}
                  ...
                  {error && !file && errorFile[0] === false && errorFile[1] === false && <small className="text-red-500">Enter a file document please!</small>}
