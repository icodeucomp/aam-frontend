  ...
  return (
    <div className="flex items-center h-full font-semibold border rounded-lg border-primary/50">
      ...
      <div className="relative w-full">
        ...
        <input type="search" className="block w-full py-2 text-sm duration-300 rounded-lg outline-none pl-10 pr-4 text-dark-blue" onChange={setSearchTerm} placeholder="Search" />
      </div>
    </div>
  );
};
