  ...
  return (
    ...
    >
      <div className="mx-2 space-y-2">
        <Img className="h-14 min-w-28 max-w-28 mx-auto" src="/logo-company.png" alt="logo PT Amanah Aulia Mandiri" />
        <span className="text-sm font-semibold text-primary">PT Amanah Aulia Mandiri</span>
      </div>
