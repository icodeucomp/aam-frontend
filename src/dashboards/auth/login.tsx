...
export const Login = () => {
  ...
  return (
    <Background src="/images/bg-login-aam.webp" className="items-center justify-center min-h-screen p-4 text-dark" isTop>
      <div className="w-full max-w-sm p-4 mx-auto border shadow-lg h-max border-primary/50 rounded-3xl text-dark bg-light z-1 sm:p-6 md:p-8">
        <form onSubmit={handleSubmit}>
          <h5 className="mb-6 text-2xl font-bold text-center text-dark-1 sm:mb-8 text-primary">Sign In</h5>
