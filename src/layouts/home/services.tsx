...
export const Services = () => {
  ...
  return (
    <div>
      <Background src="/images/construction-progress.webp" className="grid justify-center grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 mx-auto max-w-screen-2xl min-h-500">
