...
export const ProjectDetail = ({ slug }: { slug: string }) => {
  ...
  const { response: project, loading, error } = useGet<ResponseBusinessSectorTypes>({ path: `/projects/${slug}` });
  ...
  return (
    <Container className="py-20">
      <div className="flex items-center gap-4 mb-8">
        ...
        <span className="text-xl font-medium sm:text-2xl text-dark-blue">Back</span>
      </div>
