...
export const Organizational = () => {
  return (
    <Container id="organizational" className="py-16 space-y-8">
      ...
      <Motion tag="div" initialY={40} animateY={0} duration={0.6} delay={0.3} className="grid grid-cols-4">
        <div></div>
        <Img src={organizationalLists[0].pathImg} alt={organizationalLists[0].name} className={`w-full h-80 rounded-s-lg sm:h-[420px]`} cover />
        <div className="flex flex-col justify-center h-full gap-4 px-4 py-2 text-center border-l-4 text-light bg-primary border-secondary rounded-e-lg">
